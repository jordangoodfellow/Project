...
module.exports = {
  "YouPorn Account Login": function(browser) {
    ...
    browser
      .url(`${baseUrl}/`, 1421, 806, `Load page... "${baseUrl}/"`)
      .click(`.login-link`, `CSS`, `Click element`)
      .click(`div:nth-of-type(4) > div > form > div:nth-of-type(2) > input`, `CSS`, `Click element`)
      .click(`div:nth-of-type(4) > div > form > div:nth-of-type(2) > input`, `CSS`, `Click element`)
      .changeInput(`div:nth-of-type(4) > div > form > div:nth-of-type(2) > input`, `CSS`, `scott_heron`, `Change input to... "scott_heron"`)
      .click(`div > form > div:nth-of-type(3) > input`, `CSS`, `Click element`)
      .changeInput(`div > form > div:nth-of-type(3) > input`, `CSS`, `qwe123`, `Change input to... "qwe123"`)
      .click(`div > form > button`, `CSS`, `Click element`)
      .end();
  }
};
