...
module.exports = {
  "Unnamed test": function(browser) {
    ...
    var baseUrl = browser.launchUrl || `https://www.youporn.com`;


    browser
      .pathIs(`/`, `Path is... "/"`)
      .click(`.container > :nth-child(1) .js-track-btn`, `CSS`, `Click element`)
      .pathIs(`/country/ca/canada/`, `Path is... "/country/ca/canada/"`)
      .click(`div:nth-of-type(2) > div > div:nth-of-type(2) > div > div`, `CSS`, `Click element`)
      .click(`div:nth-of-type(2) > div > div:nth-of-type(2) > div > ul > li:nth-of-type(3)`, `CSS`, `Click element`)
      .pathIs(`/country/ca/canada/month/`, `Path is... "/country/ca/canada/month/"`)
      .click(`div:nth-of-type(2) > div > div:nth-of-type(2) > div > div`, `CSS`, `Click element`)
      .click(`div > div:nth-of-type(2) > div > div:nth-of-type(2)`, `CSS`, `Click element`)
      .click(`div:nth-of-type(2) > div > div:nth-of-type(2) > div > div`, `CSS`, `Click element`)
      .click(`div:nth-of-type(2) > div > div:nth-of-type(2) > div > ul > li:nth-of-type(4)`, `CSS`, `Click element`)
      .pathIs(`/country/ca/canada/year/`, `Path is... "/country/ca/canada/year/"`)
      .click(`div:nth-of-type(2) > div > div:nth-of-type(2) > div > div`, `CSS`, `Click element`)
      .click(`div:nth-of-type(2) > div > div:nth-of-type(2) > div > ul > li:nth-of-type(5)`, `CSS`, `Click element`)
      .pathIs(`/country/ca/canada/all/`, `Path is... "/country/ca/canada/all/"`)
      .click(`div > :nth-child(3) .mg-selected-item`, `CSS`, `Click element`)
      .click(`div > :nth-child(3) .mg-selection-menu`, `CSS`, `Click element`)
      .click(`div > div:nth-of-type(3) > div > ul > li:nth-of-type(48)`, `CSS`, `Click element`)
      .pathIs(`/country/us/united-states/`, `Path is... "/country/us/united-states/"`)
      .click(`div:nth-of-type(2) > div > div:nth-of-type(2) > div > div`, `CSS`, `Click element`)
      .click(`div:nth-of-type(2) > div > div:nth-of-type(2) > div > ul > li:nth-of-type(3)`, `CSS`, `Click element`)
      .pathIs(`/country/us/united-states/month/`, `Path is... "/country/us/united-states/month/"`)
      .click(`div:nth-of-type(2) > div > div:nth-of-type(2) > div > div`, `CSS`, `Click element`)
      .click(`div:nth-of-type(2) > div > div:nth-of-type(2) > div > ul > li:nth-of-type(4)`, `CSS`, `Click element`)
      .pathIs(`/country/us/united-states/month/`, `Path is... "/country/us/united-states/month/"`)
      .click(`div:nth-of-type(2) > div > div:nth-of-type(2) > div > ul > li:nth-of-type(5)`, `CSS`, `Click element`)
      .pathIs(`/country/us/united-states/all/`, `Path is... "/country/us/united-states/all/"`)
      .end();
  }
};
