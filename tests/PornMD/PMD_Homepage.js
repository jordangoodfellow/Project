...
module.exports = {
  "Unnamed test": function(browser) {
    ...
    var baseUrl = browser.launchUrl || `https://www.pornmd.com`;


    browser
      .url(`${baseUrl}/`, 1018, 643, `Load page... "${baseUrl}/"`)
      .pathIs(`/`, `Init page... "/"`)
      .click("form > div:nth-of-type(2) > input", `Click element`)
      .changeInput("form > div:nth-of-type(2) > input", `boobs`, `Change input to... "boobs"`)
      .click(".display-block", `Click element`)
      .pathIs(`/straight/boobs`, `Init page... "/straight/boobs"`)
      .click("ul > :nth-child(1) .ellipsis", `Click element`)
      .pathIs(`/straight/natural+boobs`, `Init page... "/straight/natural+boobs"`)
      .click("div:nth-of-type(5) > div > ul > li > a", `Click element`)
      .pathIs(`/straight/tinder`, `Init page... "/straight/tinder"`)
      .click("div:nth-of-type(5) > div > ul > li:nth-of-type(2) > a", `Click element`)
      .pathIs(`/straight/kali+renee`, `Init page... "/straight/kali+renee"`)
      .click(".list-menu > :nth-child(2) .js_multipleOrientationOptionSelector", `Click element`)
      .pathIs(`/gay/kali+renee`, `Init page... "/gay/kali+renee"`)
      .click(".list-menu > :nth-child(3) .js_multipleOrientationOptionSelector", `Click element`)
      .pathIs(`/tranny/kali+renee`, `Init page... "/tranny/kali+renee"`)
      .click(".list-menu > :nth-child(1) .js_multipleOrientationOptionSelector", `Click element`)
      .pathIs(`/straight/kali+renee`, `Init page... "/straight/kali+renee"`)
      .click("ul:nth-of-type(3) > li:nth-of-type(2) > a", `Click element`)
      .pathIs(`/straight/kali+renee`, `Init page... "/straight/kali+renee"`)
      .click("ul:nth-of-type(5) > li > a", `Click element`)
      .pathIs(`/straight/kali+renee`, `Init page... "/straight/kali+renee"`)
      .click("ul:nth-of-type(5) > li:nth-of-type(2) > a", `Click element`)
      .pathIs(`/straight/kali+renee`, `Init page... "/straight/kali+renee"`)
      .click("ul:nth-of-type(5) > li:nth-of-type(3) > a", `Click element`)
      .pathIs(`/straight/kali+renee`, `Init page... "/straight/kali+renee"`)
      .click("ul:nth-of-type(5) > li:nth-of-type(4) > a", `Click element`)
      .pathIs(`/straight/kali+renee`, `Init page... "/straight/kali+renee"`)
      .click("ul:nth-of-type(5) > li:nth-of-type(5) > a", `Click element`)
      .pathIs(`/straight/kali+renee`, `Init page... "/straight/kali+renee"`)
      .click("ul:nth-of-type(5) > li:nth-of-type(6) > a", `Click element`)
      .pathIs(`/straight/kali+renee`, `Init page... "/straight/kali+renee"`)
      .click("div > a > span:nth-of-type(3)", `Click element`)
      .pathIs(`/`, `Init page... "/"`)
      .end();
  }
};
