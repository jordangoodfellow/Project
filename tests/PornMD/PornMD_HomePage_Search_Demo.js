...
module.exports = {
  "[PornMD] - Homepage - Search Demo": function(browser) {
    ...
    browser
      .url(`${baseUrl}/`, 1087, 569, `Load page... "${baseUrl}/"`)
      .click("form > div:nth-of-type(2) > input", `Click element`)
      .changeInput("form > div:nth-of-type(2) > input", `Big Boobs`, `Change input to... "Big Boobs"`)
      .click(".display-block", `Click element`)
      .pathIs(`/straight/big+boobs`, `Init page... "/straight/big+boobs"`)
      .click("ul:nth-of-type(3) > li:nth-of-type(2) > a > span", `Click element`)
      .pathIs(`/straight/big+boobs`, `Init page... "/straight/big+boobs"`)
