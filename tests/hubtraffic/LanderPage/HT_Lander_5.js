...
module.exports = {
  "[HubTraffic] - Lander Body [Button Func.]": function(browser) {
    ...
    browser
      .click(".join-hub-btn", `Click element`)
      .click("header > div > a", `Click element`)
      .pathIs(`/`, `Init page... "/"`)
      .click("div:nth-of-type(2) > ul > li > a", `Click element`)
      .click("div:nth-of-type(2) > ul > li:nth-of-type(2) > a", `Click element`)
      .click("div:nth-of-type(2) > ul > li:nth-of-type(3) > a", `Click element`)
      .click(".join-now-btn", `Click element`)
      .pathIs(`/account/create`, `Init page... "/account/create"`)
      .click("header > div > a", `Click element`)
      .pathIs(`/`, `Init page... "/"`)
      .click("div:nth-of-type(4) > a > span", `Click element`)
