...
module.exports = {
  "[HubTraffic] Widget Preview - Smoketest": function(browser) {

    bindHelpers(browser);
    bindComponents(browser);

    var baseUrl = browser.launchUrl || `https://hubtraffic.com`;


    browser
      .url(`${baseUrl}/`, 1132, 636, `Load page... "${baseUrl}/"`)
      .pathIs(`/`, `Init page... "/"`)
      .click("form > div:nth-of-type(2) > div > input", `Click element`)
      .changeInput("form > div:nth-of-type(2) > div > input", `uppercutrevolution`, `Change input to... "uppercutrevolution"`)
      .changeInput("form > div:nth-of-type(2) > div:nth-of-type(2) > input", `qwe123`, `Change input to... "qwe123"`)
      .click("[name=yt0]", `Click element`)
      .formSubmit("div > div > form", `Form submit`)
      .pathIs(`/profile`, `Init page... "/profile"`)
      .click("body > div > div > ul > li:nth-of-type(2) > a", `Click element`)
      .pathIs(`/export/index`, `Init page... "/export/index"`)
      .click("div:nth-of-type(2) > div > ul > li > a > span", `Click element`)
      .pathIs(`/widgets`, `Init page... "/widgets"`)
      .click(".sites-site", `Click element`)
      .click(".pornhub-site", `Click element`)
      .pathIs(`/widgets/index`, `Init page... "/widgets/index"`)
      .click("div > h1 > a", `Click element`)
      .pathIs(`/widgets/create`, `Init page... "/widgets/create"`)
      .click("div > div:nth-of-type(3) > div > div > div > div > div:nth-of-type(2)", `Click element`)
      .click("[name=yt0]", `Click element`)
      .formSubmit("form", `Form submit`)
      .pause(2000)
      .click("div > form > h1 > a", `Click element`)
      .pathIs(`/widgets/index`, `Init page... "/widgets/index"`)
      .click(".sites-dropdown-box .sites-current .pornhub-site", `Click element`)
      .click(".redtube-site", `Click element`)
      .pathIs(`/widgets/index`, `Init page... "/widgets/index"`)
      .click("div > h1 > a", `Click element`)
      .pathIs(`/widgets/create`, `Init page... "/widgets/create"`)
      .click("div:nth-of-type(3) > div > div > div > ul > li > div > label", `Click element`)
      .click("[name=yt0]", `Click element`)
      .formSubmit("form", `Form submit`)
      .pathIs(`/widgets/update/1390960`, `Init page... "/widgets/update/1390960"`)
      .click("div > form > h1 > a", `Click element`)
      .pathIs(`/widgets/index`, `Init page... "/widgets/index"`)
      .click(".sites-dropdown-box .sites-current .redtube-site", `Click element`)
      .click(".tube8-site", `Click element`)
      .pathIs(`/widgets/index`, `Init page... "/widgets/index"`)
      .click("div > h1 > a", `Click element`)
      .pathIs(`/widgets/create`, `Init page... "/widgets/create"`)
      .click(".radio-custom-list", `Click element`)
      .click("div > div:nth-of-type(3) > div > div > div > div > div > input", `Click element`)
      .click("[name=yt0]", `Click element`)
      .pathIs(`/widgets/update/1390961`, `Init page... "/widgets/update/1390961"`)
      .click("div > form > h1 > a", `Click element`)
      .pathIs(`/widgets/index`, `Init page... "/widgets/index"`)
      .click(".sites-dropdown-box .sites-current .tube8-site", `Click element`)
      .click(".youporn-site", `Click element`)
      .pathIs(`/widgets/index`, `Init page... "/widgets/index"`)
      .click("div > h1 > a", `Click element`)
      .pathIs(`/widgets/create`, `Init page... "/widgets/create"`)
      .click("div > div:nth-of-type(3) > div > div > div > div > div:nth-of-type(3) > label", `Click element`)
      .click("[name=yt0]", `Click element`)
      .pathIs(`/widgets/update/1390962`, `Init page... "/widgets/update/1390962"`)
      .click("div > form > h1 > a", `Click element`)
      .pathIs(`/widgets/index`, `Init page... "/widgets/index"`)
      .click(".sites-dropdown-box .sites-current .youporn-site", `Click element`)
      .click(".sites-dropdown-box .sites-current .youporn-site", `Click element`)
      .click(".xtube-site", `Click element`)
      .pathIs(`/widgets/index`, `Init page... "/widgets/index"`)
      .click("div > h1 > a", `Click element`)
      .pathIs(`/widgets/create`, `Init page... "/widgets/create"`)
      .click("div > div:nth-of-type(3) > div > div > div > div > div:nth-of-type(2) > label", `Click element`)
      .click("[name=yt0]", `Click element`)
      .pathIs(`/widgets/update/1390963`, `Init page... "/widgets/update/1390963"`)
