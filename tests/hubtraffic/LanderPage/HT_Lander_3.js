...
module.exports = {
  "[HubTraffic] - Forgot Password Func. [Submit Button]": function(browser) {
    ...
    browser
      .click(".header-right > :nth-child(1) .cboxElement", `Click element`)
      .click("div:nth-of-type(2) > div > div > form > div > div > div > input", `Click element`)
      .changeInput("div:nth-of-type(2) > div > div > form > div > div > div > input", `uppercutrevolution`, `Change input to... "uppercutrevolution"`)
      .click("[name=yt1]", `Click element`)
