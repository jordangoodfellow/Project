...
module.exports = {
  "[HubTraffic] - Username Recovery [Submit Button]": function(browser) {
    ...
    browser
      ...
      .pathIs(`/`, `Init page... "/"`)
      .click(".login-error-notice > :nth-child(1) .cboxElement", `Click element`)
      .click("div:nth-of-type(2) > div > div > form > div > div > div > input", `Click element`)
      .changeInput("div:nth-of-type(2) > div > div > form > div > div > div > input", `zipzaprap@ph.mindgeek.com`, `Change input to... "zipzaprap@ph.mindgeek.com"`)
      .click("[name=yt2]", `Click element`)
      .click(".logged-out-pages > :nth-child(8) .site-button", `Click element`)
      .end();
  }
};
