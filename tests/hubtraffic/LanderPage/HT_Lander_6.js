...
module.exports = {
  "[HubTraffic] - Footer [Button Func.]": function(browser) {
    ...
    browser
      ...
      .pathIs(`/`, `Init page... "/"`)
      .click("footer > div > ul > li:nth-of-type(2) > a", `Click element`)
      .pathIs(`/terms`, `Init page... "/terms"`)
      .click("header > div > a", `Click element`)
      .pathIs(`/`, `Init page... "/"`)
      .click("footer > div > ul > li:nth-of-type(3) > a", `Click element`)
      .pathIs(`/site/contact`, `Init page... "/site/contact"`)
      .click("header > div > a", `Click element`)
      .pathIs(`/`, `Init page... "/"`)
      .click(".footer-lang-dropdown-link", `Click element`)
      .click(".change-lang", `Click element`)
      .end();
  }
};
