...
module.exports = {
  "[HubTraffic] - Contact Us [Form Func.]": function(browser) {
    ...
    browser
      ...
      .click("div > div:nth-of-type(4) > a", `Click element`)
      .pathIs(`/site/contact`, `Init page... "/site/contact"`)
      .click("div:nth-of-type(2) > form > div:nth-of-type(2) > div > input", `Click element`)
      .changeInput("div:nth-of-type(2) > form > div:nth-of-type(2) > div > input", `joe`, `Change input to... "joe"`)
      .click("div:nth-of-type(2) > form > div:nth-of-type(2) > div:nth-of-type(2) > input", `Click element`)
      .changeInput("div:nth-of-type(2) > form > div:nth-of-type(2) > div:nth-of-type(2) > input", `zipzaprap@ph.mindgeek.com`, `Change input to... "zipzaprap@ph.mindgeek.com"`)
      .click("div:nth-of-type(2) > form > div:nth-of-type(3) > input", `Click element`)
      .changeInput("div:nth-of-type(2) > form > div:nth-of-type(3) > input", `money`, `Change input to... "money"`)
      .click("textarea", `Click element`)
      .changeInput("textarea", `moneytalks`, `Change input to... "moneytalks"`)
