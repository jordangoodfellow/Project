...
module.exports = {
  "[HubTraffic] - Stats Overview - Earnings": function(browser) {
    ...
    browser
      .url(`${baseUrl}/`, 1148, 661, `Load page... "${baseUrl}/"`)
      .pathIs(`/`, `Init page... "/"`)
      ...
      .pathIs(`/profile`, `Init page... "/profile"`)
      .click(".all-domains", `Click element`)
      .click("div:nth-of-type(3) > ul > li:nth-of-type(4) > div > input", `Click element`)
      .click(".center-box .datetimepicker-inline .site-button", `Click element`)
      .pathIs(`/profile`, `Init page... "/profile"`)
      .click(".all-domains", `Click element`)
      .click("div:nth-of-type(3) > ul > li > div > a", `Click element`)
      ...
      .click(".center-box .datetimepicker-inline .site-button", `Click element`)
      .pathIs(`/profile`, `Init page... "/profile"`)
      .click("[name=dateFrom]", `Click element`)
      .click("[name=dateTo]", `Click element`)
      .formSubmit("form", `Form submit`)
      .pathIs(`/profile`, `Init page... "/profile"`)
      .click("tbody > :nth-child(1) .update", `Click element`)
